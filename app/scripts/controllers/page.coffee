...
angular.module('sc2App')
    .controller 'pageCtrl', ($scope, $rootScope, $document, $window, $state, UserService, SoundCloudService, ContentService, $localStorage, HelperService, appVersion, animation) ->
